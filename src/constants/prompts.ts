...
const PRODUCT_HINTS: [RegExp, string[]][] = [
  ...
  [/人材|採用|エージェント|CA|転職|求人|スカウト|人事|キャリア/i, ['CA生産性の限界','求人と求職者のミスマッチ','スカウト返信率低下','内定承諾率の停滞']],
...
const SUB_ISSUE_HINTS: [RegExp, string[]][] = [
  ...
  [/人材|採用|CA|スカウト/,              ['ターゲット人材へのリーチ不足', 'スカウト文の個別最適化ができていない', '面談→内定の歩留まり悪化']],
...
const PRODUCT_SUGGEST_HINTS: [RegExp, string[]][] = [
  ...
  [/人材|採用|エージェント|CA|転職|求人|スカウト|人事|キャリア/i, ['CA一人当たり生産性の限界を突破するには？','スカウト返信率を劇的に上げるアプローチは？','求人-求職者マッチング精度の改善策は？']],
