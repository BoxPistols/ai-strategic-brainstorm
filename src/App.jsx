...
const T = {
  // Layout
  page:      'min-h-screen bg-slate-100 dark:bg-slate-950 transition-colors duration-200',
  card:      'bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700/60 rounded-xl',
  cardFlat:  'bg-slate-50 dark:bg-slate-800/40 border border-slate-200 dark:border-slate-700/50 rounded-xl',
  // Text
  t1:        'text-slate-900 dark:text-slate-100',
  t2:        'text-slate-600 dark:text-slate-400',
  t3:        'text-slate-400 dark:text-slate-500',
  // Inputs
  inp:       'w-full px-3 py-2 rounded-lg bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/60 text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-500 text-sm focus:outline-none focus:border-blue-400 dark:focus:border-blue-500 transition',
  inpSm:     'w-full px-2.5 py-1.5 rounded-lg bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/60 text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-500 text-xs focus:outline-none focus:border-blue-400 dark:focus:border-blue-500 transition',
  // Buttons
  btnGhost:  'bg-slate-100 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/60 text-slate-600 dark:text-slate-400 hover:bg-slate-200 dark:hover:bg-slate-700/60 transition',
  btnAccent: 'bg-blue-600 hover:bg-blue-500 text-white shadow-sm shadow-blue-900/20',
  // Accent areas
  accentBg:  'bg-blue-50 dark:bg-blue-900/10 border border-blue-200 dark:border-blue-800/30',
    ...
    elements.push(
      <div key={`tbl-${i}`} className="overflow-x-auto my-2">
        <table className="w-full text-xs border-collapse">
          <thead><tr>{hdr.split('|').filter(Boolean).map((c, ci) => <th key={ci} className="px-2 py-1.5 text-left bg-slate-100 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/60 text-slate-700 dark:text-slate-300 font-semibold">{c.trim()}</th>)}</tr></thead>
          <tbody>{body.map((row, ri2) => <tr key={ri2} className="even:bg-slate-50 dark:even:bg-slate-800/20">{row.split('|').filter(Boolean).map((c, ci) => <td key={ci} className="px-2 py-1 border border-slate-200 dark:border-slate-700/60 text-slate-600 dark:text-slate-400">{ri(c.trim())}</td>)}</tr>)}</tbody>
        </table>
      </div>
    );
    tableRows = [];
...
const priorityC = v => ({ High: 'bg-rose-50 dark:bg-rose-900/20 text-rose-700 dark:text-rose-300 border-rose-200 dark:border-rose-700/40', Medium: 'bg-amber-50 dark:bg-amber-900/20 text-amber-700 dark:text-amber-300 border-amber-200 dark:border-amber-700/40', Low: 'bg-slate-100 dark:bg-slate-700/40 text-slate-600 dark:text-slate-400 border-slate-200 dark:border-slate-600/40' }[v] || 'bg-slate-100 dark:bg-slate-700/40 text-slate-600 dark:text-slate-400 border-slate-200');
const effortC   = v => ({ High: 'bg-purple-50 dark:bg-purple-900/20 text-purple-700 dark:text-purple-300 border-purple-200 dark:border-purple-700/40', Medium: 'bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300 border-blue-200 dark:border-blue-700/40', Low: 'bg-teal-50 dark:bg-teal-900/20 text-teal-700 dark:text-teal-300 border-teal-200 dark:border-teal-700/40' }[v] || 'bg-slate-100 dark:bg-slate-700/40 text-slate-600 dark:text-slate-400 border-slate-200');
const impactC   = v => ({ High: 'bg-emerald-50 dark:bg-emerald-900/20 text-emerald-700 dark:text-emerald-300 border-emerald-200 dark:border-emerald-700/40', Medium: 'bg-orange-50 dark:bg-orange-900/20 text-orange-700 dark:text-orange-300 border-orange-200 dark:border-orange-700/40', Low: 'bg-slate-100 dark:bg-slate-700/40 text-slate-600 dark:text-slate-400 border-slate-200 dark:border-slate-600/40' }[v] || 'bg-slate-100 dark:bg-slate-700/40 text-slate-600 dark:text-slate-400 border-slate-200');
