...
const ALL_STEPS = [
  {
    ...
    title: 'セッション種別',
    intro:
      '分析の切り口を選びます。マーケティング・グロース・DXなど、目的に応じたセッションを選択してください。',
  ...
  },
  {
    ...
    title: 'チーム目標',
    intro:
      '達成したい目標を記入します。定量的な目標（売上30%増など）を含めるとAI分析の精度が向上します。',
    position: 'bottom' as const,
  },
  {
    ...
    title: '分析深度',
    intro:
      '深度が高いほど、より詳細で専門的な分析を生成します。Pro モードでは最大 Lv4（High-Class）まで選択可能です。',
