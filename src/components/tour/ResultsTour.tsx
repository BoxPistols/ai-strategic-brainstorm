...
const STEPS = [
  {
    ...
    title: '状況分析',
    intro:
      'AIが入力情報をもとに導き出した現状認識と課題の構造です。最重要イシューがある場合は赤枠で強調されます。',
  ...
  },
  {
    ...
    title: '戦略アイデア',
    intro:
      '優先度・工数・インパクトが評価された戦略提案の一覧です。分析深度が高いほど、より詳細なアイデアが生成されます。',
  ...
  },
  {
    ...
    title: 'カード深掘り',
    intro:
      'カードにホバーすると虫眼鏡アイコンが表示されます。クリックするとそのアイデアをさらに具体化したサブプランが生成されます。',
  ...
  },
  {
    ...
    title: '全体深掘りサジェスト',
    intro:
      'AIが提案する追加の分析テーマです。クリックすると新しい視点で深掘り分析を実行し、結果が追加されます。',
    position: 'top' as const,
  },
  {
    ...
    title: 'ブラッシュアップ',
    intro:
      '方向性の修正や追加の観点を入力して「ブラッシュアップ実行」を押すと、指示を反映した新しいアイデアが履歴として追加されます。',
    position: 'top' as const,
  },
  {
