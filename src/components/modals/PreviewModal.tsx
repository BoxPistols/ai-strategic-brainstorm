    ...
    return (
        ...
        >
            ...
            >
                {/* Header */}
                <div
                    className={`flex items-center justify-between px-4 py-3 border-b ${T.div} shrink-0`}
                >
                    ...
                    <button
                        onClick={onClose}
                        className={`p-1.5 rounded-lg ${T.btnGhost} transition-colors`}
                    >
                        <X className='w-4 h-4' />
                    </button>
                </div>
                ...
                {exportType && (
                    <div className={`px-4 py-2 border-b ${T.div} flex items-center justify-between bg-slate-50/50 dark:bg-slate-900/50`}>
                ...
                <div className='flex-1 overflow-y-auto p-5 scrollbar-thin scrollbar-thumb-slate-200 dark:scrollbar-thumb-slate-800'>
                    {exportType && viewMode === 'source' ? (
                        ...
                        <div className={`whitespace-pre-wrap font-mono text-xs leading-relaxed p-4 rounded-xl ${T.inp} bg-slate-50/30 dark:bg-black/20 h-full`}>
                            {txt}
                        </div>
                    ) : (
